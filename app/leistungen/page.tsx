...
export default function Page() {
  return (
    <>
      ...
      <div
        className="section grid grid-cols-1 gap-4 sm:grid-cols-2 md:gap-8 lg:grid-cols-3"
        itemProp="makesOffer"
        itemScope
      ...
      >
        ...
        >
          ...
          <p itemProp="description">
            Die äussere Erscheinung Ihres Fahrzeugs ist oft der erste Eindruck,
            den es hinterlässt. Wir bieten eine gründliche und professionelle
            Aussenreinigung (nur Handwäsche) und Polituren an, um Ihr Auto vor
            den Elementen zu schützen und seinen Glanz zu bewahren. Wir
            verwenden hochwertige Produkte und Methoden, um Lackkratzer zu
            entfernen und eine glänzende Oberfläche zu erzielen.
          </p>
        </article>
        ...
        >
          ...
          <p itemProp="description">
            ...
            Lackaufbereitungen und Versiegelungsdienste an. Durch die Entfernung
            von Flugrost, Hologrammen und kleinen Kratzern bringen wir den Lack
            zum Strahlen und schützen ihn anschliessend mit hochwertigen
            Versiegelungen vor Umwelteinflüssen.
          </p>
        </article>
        ...
        >
          ...
          <p itemProp="description">
            ...
            potenzielle Käufer anzuziehen und den Bestmöglichen Verkaufspreis zu
            erzielen. Unsere Autoaufbereitung bietet Ihnen eine umfassende
